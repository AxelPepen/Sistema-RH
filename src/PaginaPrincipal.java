...
public class PaginaPrincipal extends JFrame {
    ...
    public void iconos(){
        URL imageUrl = getClass().getResource("/IMAGENES/admin.png");
        if (imageUrl == null) {
            System.out.println("No se pudo encontrar el recurso: /recursos/admin.png");
        } else {
            ImageIcon imageIcon1 = new ImageIcon(imageUrl);
        ...
        ImageIcon imageIcon3 = new ImageIcon("/IMAGENES/470216.png");
        ...
        ImageIcon imageIcon4 = new ImageIcon("/IMAGENES/5258411.png");
        ...
        ImageIcon imageIcon5 = new ImageIcon("/src/IMAGENES/lupa.png");
